...
class Found_Feed : ComponentActivity() {
...
fun found_feed(){
    ...
    runBlocking {
        ...
        val result = db.collection("foundfeed").get().await()
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Column(
                        ...
                        )
                {
                    ...
                    Text(
                        text = doc.get("Found_Place").toString(),
                        fontSize = 20.sp,
                        color = Color.White,
                        modifier = Modifier.padding(12.dp)
                    )
            ...
            Surface(
                ...
                Button(
                    onClick = {
                        ...
                        val subject = "REGARDING THE ITEM YOU FOUND!!"
                        val message = "I lost it . I will collect it from you"
