...
class lostpost : ComponentActivity() {
...
private fun post() {
    ...
    Column(
        ...
        val lostnear= remember { lostvalidation() }
        lostnear(lostnear.value,lostnear.error){
            lostnear.value = it
            lostnear.validate()
        }
        ...
        uploadpic()
        submit(enable = lostnear.isValid() && description.isValid(),name.value,number.value,lostnear.value,description.value)
    }
    ...
    val painter = rememberImagePainter(
        ...
        val launcher = rememberLauncherForActivityResult(
            ...
            uri?.let{
                ...
                val uploadTask = storageRef.child("lost/"+"images/"+ imageurl.value).putFile(it)
            }
        }
    Column(
        modifier = Modifier
...
private fun name(name: String, error:String?,onChange: (String)->Unit){
    ...
    val query = remember { mutableStateOf(user?.displayName) }
    Column() {
        Surface(
            modifier =Modifier.fillMaxWidth(),
            color = Color.Black,
...
@Composable
fun lostnear(text: String, error:String?,onChange: (String)->Unit){
    Column() {
        Surface(
            modifier =Modifier.fillMaxWidth(),
            color = Color.Black,
...
@Composable
private fun submit(enable:Boolean,name:String,number:String,lostnear:String,description:String){
